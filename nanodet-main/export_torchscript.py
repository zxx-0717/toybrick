...
def parse_args():
    ...
    parser.add_argument("--cfg_path", default=r'./nanodet-plus-m_416.yml',type=str, help="Path to .yml config file.")
    parser.add_argument(
        "--model_path", type=str, default=r'./nanodet-plus-m_416_checkpoint.ckpt', help="Path to .ckpt model."
    )
    parser.add_argument(
        "--out_path",
        type=str,
        default="nanodet-plus-m_416_torchscript1.pt",
        help="TorchScript model output path.",
    )
    parser.add_argument(
        "--input_shape", type=str, default='416,416', help="Model input shape."
    )
