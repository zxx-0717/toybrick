...
def parse_args():
    ...
    parser.add_argument("--cfg_path", default=r'H:\pycharmproject\nanodet-main\nanodet-plus-m_416.yml',type=str, help="Path to .yml config file.")
    parser.add_argument(
        "--model_path", type=str, default=r'H:\pycharmproject\nanodet-main\nanodet-plus-m_416_checkpoint.ckpt', help="Path to .ckpt model."
    )
    parser.add_argument(
