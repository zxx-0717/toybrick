...
def parse_args():
    ...
    parser.add_argument("--config",default=r'H:\pycharmproject\nanodet-main\nanodet-plus-m_416.yml', help="model config file path")
    parser.add_argument("--model", default=r'H:\pycharmproject\nanodet-main\nanodet-plus-m_416_checkpoint.ckpt',help="model file path")
    parser.add_argument("--path", default="./img1.png", help="path to images or video")
...
def main():
    ...
    predictor = Predictor(cfg, args.model, logger, device="cpu")#cuda:0
    ...
    if args.demo == "image":
        ...
        for image_name in files:
            ...
            result_image = predictor.visualize(res[0], meta, cfg.class_names, 0.6)
            if args.save_result:
